...
const Wishlist = () => {
    ...
    const handleCart = (product) => {
          dispatch(removeItem(product.id))
            ...
            if (existingProduct) {
                alert("Product Quantity is Incrementing cart!!!")
            }
            else {
            ...
            <div style={{paddingTop:'100px'}} className='px-5'>
                {
                    ...
                    <div className="grid grid-cols-4 gap-4">
                                {
                                    userWishlist?.map(product=><div  key={product?.id}className="rounded border p-2 shadow">
                        ...
                        <div className='flex flex-col justify-center items-center h-screen'>
                            ...
                            <h1 style={{marginTop:'25px'}} className='text-3xl text-red-600'>Your wishlist is empty</h1>
                        </div>
                }
            </div>
        </>
