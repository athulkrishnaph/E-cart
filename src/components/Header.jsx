      ...
      <Link className="text-2xl font-bold" to={"/"}>
        <i className="fa-solid fa-truck-fast me-1"></i>E cart
          ...
          <ul className="flex-1 text-right">
              { insideHome &&
                  <li className="list-none inline-block px-5"><input onChange={(e)=>dispatch(searchProduct(e.target.value.toLowerCase()))} style={{ width: '300px',color:'black' }} className="rounded p-2" type="text" placeholder="Search Products Here..."></input></li>
              }
