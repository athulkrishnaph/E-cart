...
const Footer = () => {
  ...
  <div className="flex">
    <input type="text" placeholder="Enter Your Email Here.." className="p-1 rounded" />
    <button className="btn btn-info"><i class="fa-solid fa-arrow-right"></i></button>
  </div>
  <div className="icons flex justify-content-between mt-3">
    ...
    <a href="https://github.com/" style={{ textDecoration: 'none', color: 'white' }} target="_blank"><i class="fa-solid fa-phone"></i></a>
          ...
          <p className='text-center mt-3 text-white'>Copyright © May 2024 Batch, Media Player. Built with React.</p>  </div>
  );
};
